...
<head>
    ...
    <style>
        ...
        label:has(#paytype-manual:checked) {
            border-color: var(--color-orange-500); /* brand primary */
                    ...
                    <div class="space-y-3">
                        ...
                        <label class="block">
                            ...
                            <div class="method-card flex items-center justify-between gap-3 rounded-lg border border-gray-200 bg-white px-4 py-3 hover:border-sky-300 peer-checked:border-sky-500 peer-checked:border-2 peer-checked:ring-2 peer-checked:ring-sky-100 transition">
                                ...
                                <span class="shrink-0 inline-flex items-center gap-1 rounded-full border border-sky-100 bg-sky-50 px-2.5 py-1 text-sm font-semibold text-sky-700">
