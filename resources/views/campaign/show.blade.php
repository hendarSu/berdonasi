            ...
            <div class="lg:col-span-2 space-y-4">
                ...
                <div class="w-full overflow-hidden">
                    <picture>
                        ...
                        @endif
                        <img src="{{ $cover }}" alt="{{ $c->title }}" class="w-full object-cover shadow js-media-click cursor-zoom-in" />
                    </picture>
                        ...
                        <p class="text-sm text-gray-600">Klik tombol Donasi untuk melanjutkan ke halaman donasi.</p>
                            ...
                            <div class="mt-2 space-y-3">
                                <div class="relative inline-block w-full">
                                   <a href="{{ route('campaign.donate.form', $c->slug) }}" class="flex-1 inline-flex items-center justify-center rounded-md bg-orange-500 px-4 py-2.5 text-sm font-semibold text-white shadow hover:bg-orange-600 w-full">Donasi Sekarang</a>
                                </div>
                            </div>
                </div>
                </div>
                        ...
                        <div class="rounded-md bg-white p-5 shadow">
                            ...
                            <div class="space-y-4">
                                @foreach ($related as $r)
                                    ...
                                    @endphp
                                    <a href="{{ route('campaign.show', $r->slug) }}" class="group block rounded-md border border-gray-200 hover:border-sky-300 hover:shadow-sm overflow-hidden">
                                        @if ($rCover)
                                            <img src="{{ $rCover }}" alt="{{ $r->title }}" class="w-full object-cover" />
                                        @endif
                                        <div class="p-3">
                                            <div class="line-clamp-2 text-sm font-medium text-gray-900 group-hover:text-sky-700">{{ $r->title }}</div>
